<?php 
	...
	/*login section start*/
	$loginObj = new login;
	if(isset($loginObj->con)) {
		if(isset($_POST['loginform'])) {
			$loginObj->email 	=  $_POST['email'];
	...
	if(isset($_POST['registerform'])) {
		$regObj->phone    = $_POST['contact'];
		$regObj->name     = $_POST['name'];
		$regObj->email    = $_POST['email'];
		$regObj->regpass1 = $_POST['regpwd1'];
		$regObj->regpass2 = $_POST['regpwd2'];
		$regObj->address  = $_POST['address'];
		if($regObj->regpass2 == $regObj->regpass1) {
			$regObj->registerNow();
			echo $regObj->message;
		}
	}
    ...
    <div id="navbar-top" class="navbar-top">
	    <div class="navbar-login" >
            ...
            <div class="nav_bar_account">
            	<a class = "login" href="#"><?php echo $loginObj->username ?></a>
